...
export default function App() {
  ...
  function onSearch(ciudad) {
    ...
    const apiKey2 = "3c319e47ca096f7be7010401913489ca";
    fetch(
      `http://api.openweathermap.org/data/2.5/weather?q=${ciudad}&appid=${apiKey2}&units=metric`
    )
      .then((r) => r.json())
      .then((recurso) => {
  ...
  return (
    <div className="App">
      ...
      {/*Nav--> renderiza el componente   onSearch--> Pasa la funcion a nav como propiedad */}
      <h1>The Weather Channel </h1>
      <Cards cities={cities} onClose={onClose} />{" "}
      {/*Card-->Renderiza el componente  
